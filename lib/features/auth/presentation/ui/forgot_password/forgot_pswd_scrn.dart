              ...
              listener: (_, state) async {
                ...
                if (state.isSuccess) {
                  final strMessage = switch (formState) {
                    FormStateController.initial => 'The OTP has been shared to registered email',
                    FormStateController.verification => 'OTP verfied Successfully',
                    FormStateController.update => 'Password Updated successfully. Thank you.',
                  };
                  ...
                  context.cubit<ForgotPswdCubit>()..handled()..updateState();
              ...
              builder: (_, state) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    ] else if(controller == FormStateController.verification) ...[
                      _OTPVerificationWidget(
                        controller: otpController,
                        onResend: () {
                          context
                            .cubit<ForgotPswdCubit>()
                    ...
                    AppButton(
                      ...
                      onPressed: () {
                        if (controller == FormStateController.initial) {
                          ...
                          context.cubit<ForgotPswdCubit>().verifyOTP(enteredOtp);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        AppSpacer.p24(),
        Text("Seems You've forgot your password", style: TextStyles.labelLarge(context)),
      ...
      children: [
        ...
        OTPTextField(
          ...
          otpFieldStyle: const OtpFieldStyle(
            ...
            focusBorderColor: AppColors.haintBlue,
          ),
        ...
        GestureDetector(
          onTap: onResend,
          child: Text('Resend Code', style: TextStyles.labelLarge(context)?.copyWith(color: AppColors.haintBlue)),
        ),
      ],
    );
  }
    ...
    return Column(
      children: [
        ...
        Text('Change Password',
          style: TextStyles.titleBold(context).copyWith(color: AppColors.black)),
        AppSpacer.p24(),
        Text('Please change your password', style: TextStyles.labelLarge(context)),
        SizedBox(height: context.sizeOfHeight * .15),
        AppTextField(
          title: 'Password',
