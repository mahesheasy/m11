...
extension UserExt on LoggedInUser {
  bool get isCollExecutive => userType == 'CEO';
  bool get isFBO => userType == 'FBO';
  bool get isDEO => userType == 'DEO';
  bool get isBDE => userType == 'BDE';
}
